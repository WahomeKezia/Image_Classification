...
with st.sidebar:
        st.image('mg.png')
        st.title("TeaHealthika")
        st.subheader("Accurate detection of diseases present in the Tea leaves. This helps an user to easily detect the disease and identify it's cause.")
...
def load_model():
    model=tf.keras.models.load_model('models/tea_leaf_disease_model.h5')
    return model
...
st.write("""
         # Tea Disease Detection with Remedy :tea: :coffee:
         """
         )
